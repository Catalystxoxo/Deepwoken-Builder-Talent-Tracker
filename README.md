...
> - Old [Visual C++ 2015-2022 Redistributable (x64)](https://aka.ms/vs/17/release/vc_redist.x64.exe) — required for the OCR engine. Most PCs already have this; install it if the overlay logs a DLL error on startup.
> - (Optional) New [Visual C++ 2015-2022 Redistributable (x64)](https://aka.ms/vc14/vc_redist.x64.exe)
